...
from app.conversations.models import Conversation, Message, ConversationStatusEnum, SenderTypeEnum
    ...
    async with AsyncSessionLocal() as db:  # assumes async_session() gives AsyncSession
        ...
        for i in range(conversation_count):
            ...
            conv = Conversation(
                ...
                status=random.choice([ConversationStatusEnum.ACTIVE.value,
        ...
        sender_types = [SenderTypeEnum.PATIENT.value, SenderTypeEnum.AI_AGENT.value, SenderTypeEnum.HUMAN_AGENT.value]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create sample conversations and messages")
    parser.add_argument(
        "--count",
        type=int,
        default=5,
